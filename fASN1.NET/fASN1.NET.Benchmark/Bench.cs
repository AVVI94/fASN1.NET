...
public class Bench
{
    ...
    public void Setup()
    {
        ...
        _certTag = fASN1.NET.Asn1Serializer.Deserialize(_certData);

        using var ms2 = new MemoryStream(_certReqData);
        _certReqTag = fASN1.NET.Asn1Serializer.Deserialize(_certReqData);
    }
    ...
    {
        //using var ms = new MemoryStream(_certData);
        return fASN1.NET.Asn1Serializer.Deserialize(_certData);
    }
